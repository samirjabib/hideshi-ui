    ...
    return(
        <section class="bg-gray-50 min-h-[50rem] flex items-center justify-center">
            ...
            <div class="bg-gray-100 flex rounded-2xl shadow-lg max-w-3xl p-5 items-center">
                ...
                <p class="text-xs mt-4 text-[#2b2d42]">If you are already a member, easily log in</p>
                ...
                <img class="rounded-2xl" src="https://i.etsystatic.com/28809138/r/il/7fe06d/3444852386/il_fullxfull.3444852386_tg8f.jpg"/>
                </div>
            </div>
        </section>   
    )
